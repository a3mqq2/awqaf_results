          ...
          <div class="card elegant-card mb-4">
            <div class="card-header bg-light border-0 py-3">
              <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-bold" style="color: #3c5e7f;">الخدمات</h5>
                <button
                  type="button"
                  @click="addService"
          ...
          <div class="row">
                          ...
                          <div class="col-12">
                            ...
                            <div class="input-group">
                              ...
                              <button
                                ...
                                style="background-color: #3c5e7f; border-color: #3c5e7f; color: white;"
                              >
              ...
              <div class="col-md-6">
                <div class="card summary-card sticky-top" style="top: 20px;">
                  <div class="card-header border-0 py-3" style="background-color: #3c5e7f;">
                  ...
                  <div class="card-body p-4">
                    ...
                    <div class="summary-item total-item">
                      ...
                      <span class="summary-value h4 mb-0 fw-bold" style="color: #3c5e7f;">{{ formatCurrency(total) }}</span>
                    </div>
    ...
    <div class="modal fade" :class="{ show: showAddCustomerModal }" :style="{ display: showAddCustomerModal ? 'block' : 'none' }" tabindex="-1" v-if="showAddCustomerModal">
      <div class="modal-dialog modal-lg">
        <div class="modal-content elegant-modal">
          <div class="modal-header text-white border-0" style="background-color: #3c5e7f;">
          ...
          <form @submit.prevent="addNewCustomer">
            ...
            <div class="modal-footer border-0 p-4">
              ...
              <button type="submit" class="btn elegant-btn text-white" style="background-color: #3c5e7f; border-color: #3c5e7f;">
