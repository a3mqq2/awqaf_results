@extends('layouts.app')
@section('title','اضافة نتيجة جديدة')
@section('content')
<div class="row mt-3">
  <div class="col-md-12">
    <div class="card">
        ...
        <form action="{{ route('admin.results.store') }}" method="POST">
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control @error('drawing') is-invalid @enderror"
                     name="drawing" value="{{ old('drawing') }}"
          ...
          <div class="row">
            <div class="col-md-4 mb-3">
              ...
              <input type="number" step="0.01" min="0" max="40"
                     ...
                     name="methodology_score" value="{{ old('methodology_score') }}" required>
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="number" step="0.01" min="0" max="100"
                     ...
                     name="oral_score" value="{{ old('oral_score') }}" required>
              @error('oral_score')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="number" step="0.01" min="0" max="140"
                     ...
                     name="written_score" value="{{ old('written_score') }}" required>
              @error('written_score')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <select class="form-control @error('grade') is-invalid @enderror" name="grade" required>
                ...
                <option value="راسب" {{ old('grade') == 'راسب' ? 'selected' : '' }}>راسب</option>
              </select>
              @error('grade')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control @error('certificate_location') is-invalid @enderror"
                     name="certificate_location" value="{{ old('certificate_location') }}"
          ...
          <div class="d-flex gap-2">
            <button type="submit" class="btn btn-primary">
              <i class="ti ti-device-floppy me-2"></i>حفظ النتيجة
            </button>
