...
<html lang="ar" dir="rtl">
  <head>
    <title> وزارة الاوقاف والشؤون الاسلامية | @yield('title', 'الصفحة الرئيسة')</title>
    {{-- [Meta] --}}
    <meta charset="utf-8" />
    <meta
      name="viewport"
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/themes/dark.css">
    ...
    <style>
      ...
      :root {
        --primary-color: #3c5e7f !important;
      }
      ...
      <div class="navbar-wrapper">
        <div class="m-header">
          <a href="{{ route('admin.dashboard') }}" class="b-brand text-primary">
            <img src="{{ asset('logo-white.png') }}" class="logo" width="250" alt="">
          </a>
        </div>
            ...
            <div class="card-body">
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                  <img alt="user-image" class="user-avtar wid-45 rounded-circle" src="{{ asset('https://ui-avatars.com/api/?name=' . implode('+', explode(' ', Auth::user()->name)) . '&background=3c5e7f&color=fff') }}">
                </div>
    ...
    <footer class="pc-footer">
      <div class="footer-wrapper container-fluid">
        <div class="row">
          <div class="col my-1">
            <p class="m-0">
              جميع الحقوق محفوظة | وزارة الاوقاف والشؤون الاسلامية 2025م
            </p>
          </div>
        </div>
      </div>
